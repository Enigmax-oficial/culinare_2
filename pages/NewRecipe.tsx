...
import { Plus, Trash2, Upload, Sparkles, Loader2, ArrowLeft } from 'lucide-react';
...
export default function NewRecipePage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newRecipe = {
      ...
      title,
      description,
      image: `https://picsum.photos/seed/${title}/800/600`, // Random consistent image
      category,
      prepTime,
      cookTime,
  ...
  return (
    <div className="px-4 py-8 animate-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center gap-2 mb-8">
        ...
        <h1 className="text-2xl font-black text-stone-900">Nova Receita</h1>
      </div>

      <form onSubmit={handleSubmit} className="space-y-8 pb-12">
        {/* Basic Info */}
        <div className="bg-white p-6 rounded-[32px] border border-stone-100 shadow-sm space-y-6">
           <h2 className="text-sm font-bold text-stone-900 uppercase tracking-widest mb-4">Informações Básicas</h2>
           
           <div>
             <label className="block text-xs font-bold text-stone-500 mb-2">Título da Receita *</label>
             <div className="flex gap-2">
                ...
                {process.env.API_KEY && (
                  ...
                  >
                    ...
                    <span className="hidden sm:inline">Mágica</span>
                  </button>
                )}
             </div>
           </div>
           ...
           <div>
             <label className="block text-xs font-bold text-stone-500 mb-2">Descrição</label>
             <textarea 
               value={description}
           ...
           {/* Fake Image Upload */}
           <div className="border-2 border-dashed border-stone-200 rounded-2xl p-8 flex flex-col items-center justify-center text-stone-400 cursor-pointer hover:bg-stone-50 transition-colors hover:border-orange-200">
              <Upload size={24} className="mb-2" />
              <p className="text-xs font-bold">Clique para enviar uma foto</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
           <div>
              <label className="block text-[10px] font-bold text-stone-400 mb-1">Preparo (min)</label>
           ...
           <div>
              <label className="block text-[10px] font-bold text-stone-400 mb-1">Cozimento (min)</label>
           ...
           <div>
              <label className="block text-[10px] font-bold text-stone-400 mb-1">Dificuldade</label>
            ...
            <div>
              <label className="block text-[10px] font-bold text-stone-400 mb-1">Categoria</label>
        ...
        <div className="bg-white p-6 rounded-[32px] border border-stone-100 shadow-sm">
           <h2 className="text-sm font-bold text-stone-900 uppercase tracking-widest mb-4">Ingredientes *</h2>
        ...
        {/* Steps */}
        <div className="bg-white p-6 rounded-[32px] border border-stone-100 shadow-sm">
           <h2 className="text-sm font-bold text-stone-900 uppercase tracking-widest mb-4">Modo de Preparo *</h2>
